...
import { Button,Form ,Input, Message, TextArea, Select} from 'semantic-ui-react'
    ...
    render(){
        ...
        return(
            <Layout>
                ...
                <Form onSubmit={this.onSubmit} error={!!this.state.message} loading={this.state.loading}>
                    <Form.Group>
                    ...
                    <Form.Group>
                        ...
                        <Form.Field width={8} required>
                            ...
                            <Input 
                                ...
                                onChange={(event)=>this.setState({ CreatorName: event.target.value })}
                            />
                        </Form.Field>
                    </Form.Group>
                    <Message
                    ...
                    <Button loading={this.state.loading} type='submit' color='green' fluid basic>Create</Button>
                </Form>
