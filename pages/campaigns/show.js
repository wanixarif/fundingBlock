...
class CampaignShow extends Component {
  static async getInitialProps(props) {
    ...
    const finalizedRequestsCount = await campaign.methods
      .getFinalizedRequestsCount()
      .call();
  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      await Campaign(this.props.contractAddress)
        .methods.contribute()
        .send({
          from: accounts[0],
              ...
              <Card fluid color="red">
                ...
                <Card.Content extra>
                  <div className="ui two">
                    {this.props.category} | Created by:{" "}
                    {this.props.campaignCreatorName}
                    <a
                      style={{ float: "right" }}
